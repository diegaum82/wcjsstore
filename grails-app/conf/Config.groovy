...
import grails.plugin.springsecurity.SecurityConfigType
grails.project.groupId = WCJSStore // change this to alter the default package name and Maven publishing destination
...
log4j = {
    appenders {
        console name:'stdout', layout:pattern(conversionPattern: '%d{DATE}: %c{2} %m%n')
    }
