...
function emailFormSubmission()
{
	...
	$subject = 'CheckoutMaster Form Submission';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Username:</b></td><td>' . htmlentities($_REQUEST["custom_U14292"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	if($sent)
	{
		echo '{"FormResponse": { "success": true,"redirect":"http://www.mooberry.com/wpcs/member/index.html"}}';
