...
function emailFormSubmission()
{
	...
	$subject = 'Checkout HTB Form Submission';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>First Name:</b></td><td>' . htmlentities($_REQUEST["custom_U10463"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Last Name:</b></td><td>' . htmlentities($_REQUEST["custom_U10492"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Phone:</b></td><td>' . htmlentities($_REQUEST["custom_U10475"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Password:</b></td><td>' . htmlentities($_REQUEST["custom_U10480"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Confirm Password:</b></td><td>' . htmlentities($_REQUEST["custom_U10458"],ENT_COMPAT,'UTF-8') . '</td></tr>';
