...
function emailFormSubmission()
{
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>First Name:</b></td><td>' . htmlentities($_REQUEST["custom_U9321"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Last Name:</b></td><td>' . htmlentities($_REQUEST["custom_U9355"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Phone:</b></td><td>' . htmlentities($_REQUEST["custom_U9345"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Password:</b></td><td>' . htmlentities($_REQUEST["custom_U9326"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Confirm Password:</b></td><td>' . htmlentities($_REQUEST["custom_U9338"],ENT_COMPAT,'UTF-8') . '</td></tr>';
