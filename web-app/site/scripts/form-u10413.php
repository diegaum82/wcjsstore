...
function emailFormSubmission()
{
	...
	$subject = 'Checkout EF Form Submission';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>First Name:</b></td><td>' . htmlentities($_REQUEST["custom_U10421"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Last Name:</b></td><td>' . htmlentities($_REQUEST["custom_U10450"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Phone:</b></td><td>' . htmlentities($_REQUEST["custom_U10433"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Password:</b></td><td>' . htmlentities($_REQUEST["custom_U10438"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Confirm Password:</b></td><td>' . htmlentities($_REQUEST["custom_U10416"],ENT_COMPAT,'UTF-8') . '</td></tr>';
