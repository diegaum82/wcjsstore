...
function emailFormSubmission()
{
	...
	$subject = 'Checkout Ent Form Submission';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>First Name:</b></td><td>' . htmlentities($_REQUEST["custom_U10505"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Last Name:</b></td><td>' . htmlentities($_REQUEST["custom_U10534"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Phone:</b></td><td>' . htmlentities($_REQUEST["custom_U10517"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Password:</b></td><td>' . htmlentities($_REQUEST["custom_U10522"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Confirm Password:</b></td><td>' . htmlentities($_REQUEST["custom_U10500"],ENT_COMPAT,'UTF-8') . '</td></tr>';
