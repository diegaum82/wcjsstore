...
function emailFormSubmission()
{
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Username:</b></td><td>' . htmlentities($_REQUEST["custom_U15404"],ENT_COMPAT,'UTF-8') . '</td></tr>';
